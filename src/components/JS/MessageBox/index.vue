...
<style scoped>
.messageBox{ width: 200px; height: 120px; position: absolute; left: 50%; top: 50%; margin: -60px 0 0 -100px; border: 1px #ccc solid; border-radius: 4px; background: white; box-shadow: 3px 3px 3px 3px #ccc; }
